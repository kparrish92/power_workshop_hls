...
- You can copy-paste all code from these slides directly into this script, and run any lines of it by highlighting and clicking run (or CTRL/Commnand + Enter)
]
]
---
...
# A power level of .5 means that there is only a 50 percent chance you'll detect an effect that actully exists.
...
- Effect sizes are one way to measure differences between groups.
...
- We often assume we are taking a sample from a greater distribution. 
